...
<head>
	...
	<!--[if lt IE 9]>
    <script src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/js/html5shiv.min.js"></script>
    <![endif]-->
		...
		<footer>
			...
			<div class="footer-ferramenta">
				<div class="container">
					...
					<a target="_blank" href="http://10.26.68.200/links/index.html" rel="nofollow noreferrer noopener external">.</a>
				</div>
			</div>
