...
zenity --info --title="Atenção técnico!" --text="Script de configurações pós instalação do LinuxMint 21.2 9BLOG V_01_23" --width="300" height="50"
...
Icon=/usr/share/icons/folder-remote.png
...
Type=Application
Name=SIMATEx OM
Icon=/usr/share/icons/simatex.png
...
#Type=Application
#Name=FoxItReader
#Icon=/usr/share/icons/evince.png
