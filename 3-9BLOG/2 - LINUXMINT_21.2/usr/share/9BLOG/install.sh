...
#install kesl
  ...
  dpkg -i kesl_11.4.0-1096_amd64.deb;
  wait
  dpkg -i kesl-gui_11.4.0-1096_amd64.deb
  wait
  ...
  sudo xterm -e "./kesl-setup.pl; exec $SHELL";
