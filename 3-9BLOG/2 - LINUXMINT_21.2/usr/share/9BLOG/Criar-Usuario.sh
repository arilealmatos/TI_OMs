...
useradd -m $usuario # Adiciona o novo usuário
echo $usuario:$senha | chpasswd
usermod -a -G adm,cdrom,dip,lp,lpadmin,plugdev,sambashare,scanner $usuario
cp /var/lib/AccountsService/icons/administrador /usr/share/sddm/faces/$usuario.face.icon
...
rm /usr/share/sddm/faces/$usuario.face.icon
