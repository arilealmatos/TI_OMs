...
#Apresentação
zenity --info --title="Atenção!" --text="Script de configurações pós instalação do LinuxMint 20.2 9BLOG V_05_23" --width="300" height="50"
...
#	sed -i "16s/.*/tag=$RI/" /etc/ocsinventory/ocsinventory-agent.cfg
