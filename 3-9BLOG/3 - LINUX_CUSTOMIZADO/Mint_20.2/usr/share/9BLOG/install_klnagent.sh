...
function install_network_agent() {
	...
	dpkg -i klnagent64_13.2.2-1263_amd64.deb
	#cp /usr/share/9BLOG/autoanswers.conf /opt/kaspersky/klnagent64/lib/bin/setup/
	cd /opt/kaspersky/klnagent64/lib/bin/setup/
	sudo xterm -e "./postinstall.pl; exec $SHELL";
