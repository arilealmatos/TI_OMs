...
Label(master, text="Digite o Nome do App : ", 
      bg="light grey").grid(row=0, sticky=W) 
Label(master, text="Nome : ", 
      bg="light grey").grid(row=2, sticky=W) 
Label(master, text="Versão :", 
      bg="light grey").grid(row=3, sticky=W) 
Label(master, text="Data de Instalação :", 
      bg="light grey").grid(row=4, sticky=W) 
Label(master, text="Fabricante :", 
      bg="light grey").grid(row=5, sticky=W) 
Label(master, text="Chave de Desinstalação :", 
...
b = Button(master, text="Buscar", command=app, bg="Blue") 
